 ...
 * 
 */
public class And implements Condation {
	...
	protected And(Condation condation, String name, String op, Object value) {
	...
	protected And(Condation condation, Segment segment) {
		this.condation = condation;
		this.segment = segment;
	}
	
	protected And(Condation condation, RawSql rawSql) {
		this.condation = condation;
		this.rawSql = rawSql;
	}
